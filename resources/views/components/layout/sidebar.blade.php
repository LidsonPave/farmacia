...
>
    ...
    <nav class="space-y-6 overflow-y-auto px-3 py-6">
        ...
        <div class="space-y-1">
            ...
            <x-layout.sidebar-link :href="route('vendas.index')" :active="request()->routeIs('vendas.*')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="h-5 w-5 shrink-0">
        ...
        <div class="space-y-1">
            ...
            @if(auth()->user()->isAdmin())
            <x-layout.sidebar-link :href="route('relatorios.index')" :active="request()->routeIs('relatorios.*')">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="h-5 w-5 shrink-0">
