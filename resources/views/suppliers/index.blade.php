<x-app-layout>
    ...
    >
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
            <form method="GET" action="{{ route('fornecedores.index') }}" class="flex flex-wrap items-end gap-4 border-b border-gray-200 bg-gray-50/60 p-4 sm:p-5">
                ...
                <div class="flex w-full gap-2 sm:w-auto">
                    ...
                    @if(request()->anyFilled(['search']))
                        <a href="{{ route('fornecedores.index') }}" class="rounded-lg px-4 py-2 text-sm font-medium text-gray-500 transition hover:text-gray-700">
                            Limpar
                        </a>
                    @endif
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Telefone</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($suppliers as $supplier)
                            <tr class="transition hover:bg-gray-50">
                                <td class="px-4 py-3.5 font-medium text-gray-900">{{ $supplier->name }}</td>
                                <td class="px-4 py-3.5 text-gray-600">{{ $supplier->phone ?? '—' }}</td>
